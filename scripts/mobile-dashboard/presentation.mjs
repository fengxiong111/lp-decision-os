...
.diagnostics-section{margin:18px 10px 0;border-top:1px solid var(--line)}.verification-panel{padding:0}.verification-panel summary{padding:14px 0;color:var(--ink);font-size:13px;font-weight:700;cursor:pointer;list-style:none}.verification-panel summary::-webkit-details-marker{display:none}.verification-panel summary::after{content:"＋";float:right;color:var(--muted);font-size:16px;font-weight:400}.verification-panel[open] summary::after{content:"−"}.verification-list{padding:0 0 12px}.verification-row{display:grid;grid-template-columns:minmax(150px,1.2fr) 100px minmax(160px,1fr);gap:16px;padding:9px 0;border-top:1px solid rgba(222,219,208,.65);font-size:12px}.verification-row .pair-label{font-weight:650}.status-ready{color:var(--pass)}.status-near{color:var(--warn)}.status-blocked{color:var(--danger)}.drawer-status.status-ready{font-size:15px}.blocker{color:var(--muted);text-align:right}
