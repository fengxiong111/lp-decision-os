...
:root{--paper:#f5f4ed;--ink:#141413;--muted:#6b6a64;--line:#dedbd0;--blue:#1b365d}*{box-sizing:border-box}body{margin:0;background:var(--paper);color:var(--ink);font:16px/1.5 -apple-system,BlinkMacSystemFont,"PingFang SC","Microsoft YaHei",sans-serif}main{max-width:1240px;margin:auto;padding:34px 28px 60px}.ranking{border-top:1px solid var(--line)}.ranking-row{display:grid;grid-template-columns:52px minmax(180px,1.3fr) repeat(3,minmax(120px,.8fr)) minmax(145px,.9fr) 120px;gap:16px;align-items:center;padding:22px 10px;border-bottom:1px solid var(--line)}.rank{color:var(--blue);font:500 19px/1 Georgia,serif}.asset,.metric,.estimate,.price{display:grid;gap:5px;min-width:0}.asset strong,.estimate strong{font-family:"Iowan Old Style","Songti SC",STSong,Georgia,serif;font-weight:500}.asset strong{font-size:22px}.asset small,.metric small,.estimate small,.price small{overflow:hidden;color:var(--muted);font-size:12px;text-overflow:ellipsis;white-space:nowrap}.metric strong,.price strong{overflow:hidden;color:var(--ink);font-size:15px;font-weight:500;text-overflow:ellipsis;white-space:nowrap}.estimate strong{color:var(--blue);font-size:24px;font-variant-numeric:tabular-nums}.mobile-price{display:none}footer{margin-top:42px;padding-top:18px;border-top:1px solid var(--line);color:var(--muted);font-size:12px;line-height:1.7}footer a{color:var(--blue)}@media(max-width:960px){main{padding:26px 22px 50px}.ranking-row{grid-template-columns:42px minmax(160px,1.2fr) repeat(2,minmax(105px,.8fr)) 140px}.volume,.price{display:none}}@media(max-width:680px){main{padding:20px 16px 40px}.ranking-row{grid-template-columns:34px minmax(0,1fr) 120px;gap:10px;padding:19px 2px}.metric,.price{display:none}.rank{font-size:17px}.asset strong{font-size:20px}.asset small,.estimate small{font-size:11px}.estimate{text-align:right}.estimate strong{font-size:21px}.estimate .mobile-price{display:block;color:var(--ink);font-size:11px}footer{font-size:11px}}
