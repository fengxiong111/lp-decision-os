...
test("Next.js serves the Chinese real-data RWA decision surface", async () => {
  ...
  try {
    ...
    for (const removed of ["公开市场：", "实时索引：", "最近 Swap：", "最近成功更新：", "REST兜底", "我的仓位", "系统详情", "投入金额", "决策窗口", "唯一默认排名", "默认筛选", "显示低TVL/隔离池", "10,000U", "1小时", "6小时", "12小时", "RWA LIQUIDITY NOTE", "今天，流动性把机会放在哪里？", "00 · TOP THREE", "优先查看", "01 · FULL RANKING", "1,000U 手续费排名"]) {
